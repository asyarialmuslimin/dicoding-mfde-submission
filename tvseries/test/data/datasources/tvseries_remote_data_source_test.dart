      ...
      () async {
        when(
          ...
          (_) async => http.Response(
            readJson('dummy_data/tvseries_now_playing.json'),
            200,
          ),
        );
    ...
    test(
      ...
      () async {
        when(
          ...
          (_) async => http.Response(
            readJson('dummy_data/tvseries_top_rated.json'),
            200,
          ),
        );
    ...
    test(
      ...
      () async {
        ...
        when(
          ...
          (_) async => http.Response(
            readJson('dummy_data/tvseries_recommendation.json'),
            200,
          ),
        );
        // act
  ...
  group('search TV Series', () {
    ...
    test('should return list of TV Series when response code is 200', () async {
      ...
      when(
        ...
        (_) async => http.Response(
          readJson('dummy_data/search_mrrobot_tvseries.json'),
          200,
        ),
      );
      // act
